...
public class TC_MAI_003AcntinfofromSitemap extends Baseclass{
	@Test
	public void AcntinfofromSitemap() {
		...
		macc.siteMap();
		macc.accountInfoinSITEMAPpage();
        System.out.println("We are in Site map "+driver.getTitle()+ " page");
